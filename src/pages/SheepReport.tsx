...
import { SHEEP_REPORT_DATA as data } from '../data/sheepReportData';
...
const SheepReport = () => {
  return (
    <div className="min-h-screen bg-[#F5F5F0] pb-20"> {/* Slightly warmer background for Sheep */}
